...
out='/nix/store/0mzcrd12n916x960p9a6bg1kwxafmff6-devenv-shell-env'
export out
...
HOSTTYPE='x86_64'
defaultBuildInputs=''
DEVENV_PROFILE='/nix/store/y1ap9dll70sq8vpphj1hwvq00i1xgvqh-devenv-profile'
...
export DEVENV_STATE
outputDoc='out'
NIX_LDFLAGS='-rpath /nix/store/0mzcrd12n916x960p9a6bg1kwxafmff6-devenv-shell-env/lib  -L/nix/store/kggymrkys7zixc07ll86jg7bb97h1rrb-clang-tools-21.1.8/lib -L/nix/store/vj8m1cbj1xw2b3j55ppcby5mnchb9iml-gdb-17.1/lib -L/nix/store/kggymrkys7zixc07ll86jg7bb97h1rrb-clang-tools-21.1.8/lib -L/nix/store/vj8m1cbj1xw2b3j55ppcby5mnchb9iml-gdb-17.1/lib'
export NIX_LDFLAGS
outputBin='out'
AS='as'
export AS
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/y1ap9dll70sq8vpphj1hwvq00i1xgvqh-devenv-profile" ]
then
  ln -snf /nix/store/y1ap9dll70sq8vpphj1hwvq00i1xgvqh-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
prefix='/nix/store/0mzcrd12n916x960p9a6bg1kwxafmff6-devenv-shell-env'
cmakeFlags=''
export cmakeFlags
...
exec /tmp/devenv-envOkDzIW/script 